...
import com.sales.controller.InvControl;
...
public class OrignalFrame extends javax.swing.JFrame {
    ...
    public ArrayList<InvAllData> getInvoices() // to get invoices
    {
       if (invoices == null) invoices = new ArrayList<>();
        return invoices;
    }

    public void setInvoices(ArrayList<InvAllData> invoices) // to set invoices
    {
        this.invoices = invoices;
    }

    public TableModelInv getTableModelInv() // get table of invoices
    {
    ...
    public void setTableModelInv(TableModelInv tableModelInv)     // set table of invoices
    {
        this.tableModelInv = tableModelInv;
    }
//  label of CustomerName
